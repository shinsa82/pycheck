...
from .executor import execute, PyCheckAssumeError
from .random.random_generators import rand_int
...
def typecheck(term: Any, reftype_str: TypeStr = None, detail=False) -> bool | Result:
    ...
    locals_ = {'rand_int': rand_int, 'PyCheckAssumeError': PyCheckAssumeError}
